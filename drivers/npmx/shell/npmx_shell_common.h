...
#ifndef ZEPHYR_DRIVERS_NPMX_SHELL_NPMX_SHELL_COMMON_H__
#define ZEPHYR_DRIVERS_NPMX_SHELL_NPMX_SHELL_COMMON_H__
...
#endif /* ZEPHYR_DRIVERS_NPMX_SHELL_NPMX_SHELL_COMMON_H__ */
