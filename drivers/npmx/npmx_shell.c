...
void dynamic_cmd_adc(size_t idx, struct shell_static_entry *entry);
SHELL_DYNAMIC_CMD_CREATE(sub_adc, dynamic_cmd_adc);

void dynamic_cmd_buck(size_t idx, struct shell_static_entry *entry);
SHELL_DYNAMIC_CMD_CREATE(sub_buck, dynamic_cmd_adc);
