...
This BUCK sample variant demonstrates how to control the enable mode for the buck converter with GPIO with the use of npmx drivers.
...
.. |sample path| replace:: :file:`samples/buck_pins`
