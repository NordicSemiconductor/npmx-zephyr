.. _buck_output_simple_sample:

BUCK - Simple output voltage setting
####################################
...
This BUCK sample variant demonstrates how to set simple output voltage with the use of npmx drivers.
...
You can set the output voltage to 2.4 V (:c:enumerator:`NPMX_BUCK_VOLTAGE_2V4`) on BUCK1.
...
.. |sample path| replace:: :file:`samples/buck_output_simple`
...
#. |connect_kit|
#. |connect_terminal|
#. Check output voltage on EK **VOUT1** pin - it should be 2.4 V.
